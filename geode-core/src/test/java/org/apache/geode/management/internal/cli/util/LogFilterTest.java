...
public class LogFilterTest {
  ...
  public void startDateCanFilterLines() {
    ...
    assertThat(logFilter.acceptsLogEntry("info", LocalDateTime.now().minusDays(3))).isEqualTo(
        LINE_REJECTED);
  }
  ...
  public void endDateCanFilterLines() {
    ...
    assertThat(logFilter.acceptsLogEntry("info", LocalDateTime.now())).isEqualTo(
  ...
  public void filterWorksWithLevelBasedAndTimeBasedFiltering() {
    ...
    assertThat(logFilter.acceptsLogEntry("error", LocalDateTime.now().minusDays(6))).isEqualTo(LINE_REJECTED);
    assertThat(logFilter.acceptsLogEntry("info", LocalDateTime.now().minusDays(6))).isEqualTo(LINE_REJECTED);

    assertThat(logFilter.acceptsLogEntry(null)).isEqualTo(LINE_REJECTED);


    assertThat(logFilter.acceptsLogEntry("error", LocalDateTime.now().minusDays(4))).isEqualTo(LINE_REJECTED);
    assertThat(logFilter.acceptsLogEntry(null)).isEqualTo(LINE_REJECTED);

    assertThat(logFilter.acceptsLogEntry("info", LocalDateTime.now().minusDays(4))).isEqualTo(LINE_ACCEPTED);
    assertThat(logFilter.acceptsLogEntry(null)).isEqualTo(LINE_ACCEPTED);



    assertThat(logFilter.acceptsLogEntry("error", LocalDateTime.now().minusDays(1))).isEqualTo(REMAINDER_OF_FILE_REJECTED);
    assertThat(logFilter.acceptsLogEntry(null)).isEqualTo(REMAINDER_OF_FILE_REJECTED);

    assertThat(logFilter.acceptsLogEntry("info", LocalDateTime.now().minusDays(1))).isEqualTo(REMAINDER_OF_FILE_REJECTED);
  }
