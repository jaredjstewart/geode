...
public class ConnectToLocatorSSLDUnitTest {
  ...
  private void setUpLocatorAndConnect(Properties securityProps, final boolean useHttp)
      throws Exception {
  ...
  @Test
  public void testConnectToLocatorOverJMX_withSSL() throws Exception {
    setupSSLProperties();
    setUpLocatorAndConnect(securityProps, false);
  }
  ...
  @Test
  public void testConnectToLocatorOverJMX_withLegacyClusterSSL() throws Exception {
  ...
  @Test
  public void testConnectToLocatorOverJMX_withLegacyJMXManagerSSL() throws Exception {
