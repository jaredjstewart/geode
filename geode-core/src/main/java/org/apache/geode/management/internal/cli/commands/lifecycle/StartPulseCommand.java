...
public class StartPulseCommand implements CommandMarker {
  ...
  public Result startPulse(@CliOption(key = CliStrings.START_PULSE__URL,
    ...
    try {
      ...
      return ResultBuilder.createShellClientErrorResult(
          String.format(CliStrings.START_PULSE__ERROR, AbstractCommandsSupport.toString(t, false)));
    }
  }

  private void browse(URI uri) throws IOException {
    AbstractCommandsSupport.assertState(Desktop.isDesktopSupported(),
