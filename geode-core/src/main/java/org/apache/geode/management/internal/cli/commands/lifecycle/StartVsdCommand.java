...
import static org.apache.geode.management.internal.cli.commands.AbstractCommandsSupport.assertState;
...
public class StartVsdCommand implements CommandMarker {
  ...
  public Result startVsd(@CliOption(key = CliStrings.START_VSD__FILE,
    ...
    try {
      ...
      if (AbstractCommandsSupport.isDebugging()) {
        getGfsh().printAsInfo(
