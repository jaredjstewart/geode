...
import static org.apache.geode.management.internal.cli.commands.AbstractCommandsSupport.getGfsh;
...
public class SharedConfiguration {
  ...
  public static String getFromLocator(String locatorHostName, int locatorPort)
  ...
  public static String getFromLocator(LocatorLauncher.LocatorState locatorState)
      throws ClassNotFoundException, IOException {
    return getFromLocator(locatorState.getHost(), Integer.parseInt(locatorState.getPort()));
  }
}
