...
public class StatusLocatorCommand implements CommandMarker {
  ...
  public Result statusLocator(
    ...
    try {
      ...
      return ResultBuilder.createShellClientErrorResult(String.format(
          ...
          AbstractCommandsSupport.toString(t, getGfsh().getDebug())));
    }
  }
  ...
  protected Result createStatusLocatorResult(final LocatorLauncher.LocatorState state)
    ...
    infoResultData.addLine(SharedConfiguration.getFromLocator(state));
